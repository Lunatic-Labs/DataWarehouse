...
query_data_bp = Blueprint("interface_query_data_bp", __name__, url_prefix="/interface_query")
######
# 4/6/2023: Copied over directly from query_data_controller, only changed the url above.
